# Generated by Django 2.0.6 on 2020-06-30 03:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(db_constraint=False, related_name='book', to='api.Author')),
            ],
            options={
                'verbose_name': '图书',
        ...
        migrations.AddField(
            model_name='book',
            name='publish',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='book', to='api.Press'),
        ),
    ]
